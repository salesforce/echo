...
import com.salesforce.casp.echo.web.Header.Type;
import com.salesforce.casp.echo.web.filter.FilterServletOutputStream;
...
/**
 * Provides a wrapper for {@link HttpServletResponseWrapper}.
 * <p/>
...
public class GenericResponseWrapper extends HttpServletResponseWrapper implements Serializable {
    ...
    /**
     * @see HttpServletResponseWrapper#addDateHeader(String, long)
     */
    @Override
    ...
    /**
     * @see HttpServletResponseWrapper#setDateHeader(String, long)
     */
    @Override
    ...
    /**
     * @see HttpServletResponseWrapper#addIntHeader(String, int)
     */
    @Override
    ...
    /**
     * @see HttpServletResponseWrapper#setIntHeader(String, int)
     */
    @Override
    ...
    public Collection getHeaders() {
        ...
        for (final Map.Entry<String, List<Serializable>> headerEntry : this.headersMap.entrySet()) {
            ...
            for (final Serializable value : headerEntry.getValue()) {
                final Type type = Type.determineType(value.getClass());
                switch (type) {
                    case STRING:
