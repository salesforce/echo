...
import com.salesforce.casp.echo.web.GenericResponseWrapper;
import com.salesforce.casp.echo.web.ResponseUtil;
 ...
 */
public class GzipFilter extends AbstractBaseFilter {
    ...
    /**
     * A template method that performs any AbstractBaseFilter specific destruction tasks. Called from {@link #destroy()}
     */
